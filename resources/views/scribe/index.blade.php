...
Step 3: Direct password reset using reset_token, no email/SMS.</a>
                ...
                <li class="tocify-item level-1" data-unique="office-cvs">
                    ...
                    <ul id="tocify-header-public-pages" class="tocify-header">
                <li class="tocify-item level-1" data-unique="public-pages">
                    <a href="#public-pages">Public / Pages</a>
                </li>
                                    <ul id="tocify-subheader-public-pages" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="public-pages-GETapi-v1-pages--slug-">
                                <a href="#public-pages-GETapi-v1-pages--slug-">Show a public page by slug</a>
                            </li>
                                                                        </ul>
                            </ul>
...
Paginated list. Use ?per_page=0 or ?all=1 to fetch all.</a>
                ...
                <li class="tocify-item level-1" data-unique="system-nationalities">
                    ...
                    <ul id="tocify-header-system-pages" class="tocify-header">
                <li class="tocify-item level-1" data-unique="system-pages">
                    <a href="#system-pages">System / Pages</a>
                </li>
                                    <ul id="tocify-subheader-system-pages" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="system-pages-GETapi-v1-admin-system-pages">
                                <a href="#system-pages-GETapi-v1-admin-system-pages">List pages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="system-pages-POSTapi-v1-admin-system-pages">
                                <a href="#system-pages-POSTapi-v1-admin-system-pages">Create a page with translations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="system-pages-PUTapi-v1-admin-system-pages--id-">
                                <a href="#system-pages-PUTapi-v1-admin-system-pages--id-">Update a page and/or its translations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="system-pages-DELETEapi-v1-admin-system-pages--id-">
                                <a href="#system-pages-DELETEapi-v1-admin-system-pages--id-">Soft delete a page</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="system-pages-POSTapi-v1-admin-system-pages--id--toggle">
                                <a href="#system-pages-POSTapi-v1-admin-system-pages--id--toggle">Toggle active</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<div class="bash-example">
    ...
    --form "active="\
    --form "blocked=1"\
    --form "image=@C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php5698.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php5698.tmp</code></p>
        </div>
        </form>
...
<p>The ID of the cv. Example: <code>consequatur</code></p>
                ...
                <h1 id="public-pages">Public / Pages</h1>
                                ...
                                <h2 id="public-pages-GETapi-v1-pages--slug-">Show a public page by slug</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://mery.alemtayaz.com/api/v1/pages/privacy?lang=consequatur"</code></pre></div>


<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://mery.alemtayaz.com/api/v1/pages/privacy"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The page key. Example: <code>privacy</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="lang"                data-endpoint="GETapi-v1-pages--slug-"
               value="consequatur"
               data-component="query">
    <br>
<p>Optional language code (ar, en, ar-SA) Example: <code>consequatur</code></p>
            </div>
                </form>
...
<div class="bash-example">
    ...
    --form "logo=@C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php16BF.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>image Example: <code>C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php16BF.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<div class="bash-example">
    ...
    --form "insurance_amount=10000"\
    --form "currency_code=EGP"\
    --form "logo=@C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php16CF.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>image Example: <code>C:\Users\ahmednour\AppData\Local\Microsoft\WinGet\Packages\Astronomer.Astro_Microsoft.Winget.Source_8wekyb3d8bbwe\php16CF.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<p>Translated name. Example: <code>سعودي</code></p>
                ...
                <h1 id="system-pages">System / Pages</h1>
                                ...
                                <h2 id="system-pages-GETapi-v1-admin-system-pages">List pages</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://mery.alemtayaz.com/api/v1/admin/system/pages?q=policy&amp;active=1&amp;per_page=15"</code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="q"                data-endpoint="GETapi-v1-admin-system-pages"
               value="policy"
               data-component="query">
    <br>
<p>Search in title/content. Example: <code>policy</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<p>Example: <code>15</code></p>
                    ...
                    <h2 id="system-pages-POSTapi-v1-admin-system-pages">Create a page with translations</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^[a-z0-9-_.]+$/. Must not be greater than 64 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="meta"                data-endpoint="POSTapi-v1-admin-system-pages"
               value=""
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="translations.0.title"                data-endpoint="POSTapi-v1-admin-system-pages"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="translations.0.content"                data-endpoint="POSTapi-v1-admin-system-pages"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="system-pages-PUTapi-v1-admin-system-pages--id-">Update a page and/or its translations</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://mery.alemtayaz.com/api/v1/admin/system/pages/consequatur" \
    --header "Content-Type: application/json" \
    --data "{
    \"slug\": \"vmqeopfuudtdsufvyvddq\",
    \"active\": false,
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-admin-system-pages--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the page. Example: <code>consequatur</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>slug</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="meta"                data-endpoint="PUTapi-v1-admin-system-pages--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="translations.0.title"                data-endpoint="PUTapi-v1-admin-system-pages--id-"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>This field is required when <code>translations</code> is present. Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>content</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="translations.0.content"                data-endpoint="PUTapi-v1-admin-system-pages--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="system-pages-DELETEapi-v1-admin-system-pages--id-">Soft delete a page</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://mery.alemtayaz.com/api/v1/admin/system/pages/consequatur"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-admin-system-pages--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the page. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="system-pages-POSTapi-v1-admin-system-pages--id--toggle">Toggle active</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://mery.alemtayaz.com/api/v1/admin/system/pages/consequatur/toggle" \
    --header "Content-Type: application/json" \
    --data "{
    \"active\": true
}"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-system-pages--id--toggle"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the page. Example: <code>consequatur</code></p>
